...
<!-- BEGIN: ci-status -->
_Last refreshed: 2026-06-04 21:41 UTC. Window: runs created since 00:00 UTC today (`2026-06-04T00:00:00Z`)._
...
| [`cypher-rs`](https://github.com/erphq/cypher-rs) | 130 | 3 | 3 | 0 | 0 |
...
| **Total** | **779** *(across 7 badged repos)* | **9** | **9** | **0** | **0** |
