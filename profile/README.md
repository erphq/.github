...
<!-- BEGIN: ci-status -->
_Last refreshed: 2026-06-17 22:42 UTC. Window: runs created since 00:00 UTC today (`2026-06-17T00:00:00Z`)._
...
| [`cypher-rs`](https://github.com/erphq/cypher-rs) | 130 | 8 | 6 | 2 | 0 |
...
| **Total** | **779** *(across 7 badged repos)* | **8** | **6** | **2** | **0** |
