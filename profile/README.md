...
<!-- BEGIN: ci-status -->
_Last refreshed: 2026-05-28 21:46 UTC. Window: runs created since 00:00 UTC today (`2026-05-28T00:00:00Z`)._
...
| [`pm-bench`](https://github.com/erphq/pm-bench) | 232 | 4 | 4 | 0 | 0 |
...
| **Total** | **752** *(across 7 badged repos)* | **11** | **11** | **0** | **0** |
