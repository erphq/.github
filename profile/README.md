...
<!-- BEGIN: ci-status -->
_Last refreshed: 2026-05-04 15:51 UTC. Window: runs created since 00:00 UTC today (`2026-05-04T00:00:00Z`)._
...
| [`skillcheck`](https://github.com/erphq/skillcheck) | 70 | 1 | 1 | 0 | 0 |
| [`skills`](https://github.com/erphq/skills) | — | 0 | 0 | 0 | 0 |
| **Total** | **745** *(across 7 badged repos)* | **6** | **6** | **0** | **0** |
