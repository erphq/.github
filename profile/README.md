...
<!-- BEGIN: ci-status -->
_Last refreshed: 2026-06-03 19:33 UTC. Window: runs created since 00:00 UTC today (`2026-06-03T00:00:00Z`)._
...
| [`cypher-rs`](https://github.com/erphq/cypher-rs) | 130 | 4 | 4 | 0 | 0 |
...
| [`pm-rag`](https://github.com/erphq/pm-rag) | 104 | 2 | 2 | 0 | 0 |
| [`skillcheck`](https://github.com/erphq/skillcheck) | 77 | 6 | 6 | 0 | 0 |
| [`skills`](https://github.com/erphq/skills) | — | 0 | 0 | 0 | 0 |
| **Total** | **779** *(across 7 badged repos)* | **20** | **20** | **0** | **0** |
