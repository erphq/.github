...
<!-- BEGIN: ci-status -->
_Last refreshed: 2026-05-05 19:41 UTC. Window: runs created since 00:00 UTC today (`2026-05-05T00:00:00Z`)._
...
| [`skills`](https://github.com/erphq/skills) | — | 3 | 3 | 0 | 0 |
| **Total** | **745** *(across 7 badged repos)* | **9** | **9** | **0** | **0** |
