...
<!-- BEGIN: ci-status -->
_Last refreshed: 2026-05-03 13:40 UTC. Window: runs created since 00:00 UTC today (`2026-05-03T00:00:00Z`)._
...
| [`skillcheck`](https://github.com/erphq/skillcheck) | 70 | 6 | 6 | 0 | 0 |
| [`skills`](https://github.com/erphq/skills) | — | 0 | 0 | 0 | 0 |
| **Total** | **745** *(across 7 badged repos)* | **38** | **37** | **1** | **0** |
