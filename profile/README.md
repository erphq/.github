...
<!-- BEGIN: ci-status -->
_Last refreshed: 2026-06-08 13:46 UTC. Window: runs created since 00:00 UTC today (`2026-06-08T00:00:00Z`)._
...
| [`skillcheck`](https://github.com/erphq/skillcheck) | 77 | 1 | 1 | 0 | 0 |
| [`skills`](https://github.com/erphq/skills) | — | 0 | 0 | 0 | 0 |
| **Total** | **779** *(across 7 badged repos)* | **1** | **1** | **0** | **0** |
