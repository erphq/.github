...
<!-- BEGIN: ci-status -->
_Last refreshed: 2026-06-10 17:18 UTC. Window: runs created since 00:00 UTC today (`2026-06-10T00:00:00Z`)._
...
| [`cypher-rs`](https://github.com/erphq/cypher-rs) | 130 | 6 | 2 | 4 | 0 |
...
| **Total** | **779** *(across 7 badged repos)* | **6** | **2** | **4** | **0** |
