...
<!-- BEGIN: ci-status -->
_Last refreshed: 2026-06-03 13:58 UTC. Window: runs created since 00:00 UTC today (`2026-06-03T00:00:00Z`)._
...
| [`mcprec`](https://github.com/erphq/mcprec) | 80 | 4 | 4 | 0 | 0 |
...
| **Total** | **779** *(across 7 badged repos)* | **16** | **16** | **0** | **0** |
